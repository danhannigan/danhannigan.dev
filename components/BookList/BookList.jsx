...
function BookList({ data }) {
  return (
    <div className="mb-6 flex overflow-x-scroll">
      <div className="mr-12">
      ...
      <div className="grid grid-flow-col gap-5">
        {data.map((item) => (
          <div className="flex flex-col" key={item.id}>
            ...
            <div className="z-10 mx-auto -mt-3">
              {item.status === "Reading" ? (
